...
#         (3)     (5)
    ...
    while not rospy.is_shutdown():
        ...
        try:
            ...
            z = -0.133 # trans.transform.translation.z   # TODO: grid loc z (marker lifted)
            
            # trans.transform.translation gives current x, y, z
            locs = [(x, y, z),(x, y-width, z),(x, y-width, z+height),(x+offs, y-width, z+height),(x+offs, y-width, z),(x+offs, y, z),(x+offs, y, z+height),(x+(2*offs), y-offs, z+height),(x+(2*offs), y-offs, z),(x-offs, y-offs, z),(x-offs, y-offs, z+height),(x-offs, y-(2*offs), z+height), (x-offs, y-(2*offs), z), (x+(2*offs), y-(2*offs), z)]
